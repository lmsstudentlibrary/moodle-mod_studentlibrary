...
$string['studentlibrary:id_error_booke'] = 'Неверный идентификатор книги';
$string['studentlibrary:id_error_booke_not_faind'] = 'Такой идентификатор не найден';
...
$string['studentlibrary:nonewmodules'] = 'Модулей не найдено';
...
$string['studentlibrary:placeholder_s'] = 'Реанимация, Пропедевтика';
...
$string['studentlibrary:studentlibraryname'] = 'НАЗВАНИЕ ЭЛЕМЕНТА (КНИГИ) В КУРСЕ';

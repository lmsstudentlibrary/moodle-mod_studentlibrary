...
$string['studentlibrary:id_error_booke'] = 'Invalid book ID';
$string['studentlibrary:id_error_booke_not_faind'] = 'No such ID was found';
...
$string['studentlibrary:nonewmodules'] = 'No modules found';
...
$string['studentlibrary:placeholder_s'] = 'Resuscitation, Propaedeutics';
...
$string['studentlibrary:studentlibraryname'] = 'NAME OF ITEM (BOOK) IN THE COURSE';
